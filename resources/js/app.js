...
var router = new VueRouter({
  ...
  routes: [
       ...
       { path: '/res', name: 'resultado', component: require('./components/ResultadoComponent.vue').default },
       { path: '/exit', name: 'salir', component: require('./components/ExitComponent.vue').default },
   		 { path: '/graph', name: 'grafica', component: require('./components/GraphComponent.vue').default },
    ],
});
